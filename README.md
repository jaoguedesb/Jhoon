...
- A renderização é feita com raycasting, e não com uma engine 3D completa.
- Os sprites são redimensionados dinamicamente para simular profundidade.
- O jogo combina animação de sprites, lógica de combate, coleta de itens e interface em um único loop principal.
- O modo desenvolvedor ajuda a testar mecânicas e estados especiais com mais rapidez.

## Possíveis Melhorias

- Adicionar novos mapas ou geração procedural
- Criar sistema de save/load
- Expandir a variedade de inimigos
- Adicionar mais efeitos visuais, como reflexão ou efeitos de projéteis
- Incluir screenshots e GIFs no README

## Créditos

Projeto desenvolvido em Python com Pygame, com inspiração em jogos de tiro clássicos em estilo retrô.
